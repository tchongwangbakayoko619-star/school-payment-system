...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/inde.css')); ?>">
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-admin sticky-top">
    <div class="container">
        <!-- Logo -->
        <a class="navbar-brand" href="<?php echo e(Route('home')); ?>"> <!-- Link logo to home -->
        ...
        <div class="collapse navbar-collapse" id="adminNavbar">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0"> <!-- Added mb-2 mb-lg-0 for better spacing on collapse -->
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('home') ? 'active' : ''); ?>" href="<?php echo e(Route('home')); ?>"> <!-- Dynamic active class -->
                        <i class="fas fa-tachometer-alt"></i>
                        Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('afficher') ? 'active' : ''); ?>" href="<?php echo e(Route('afficher')); ?>"> <!-- Dynamic active class -->
                        <i class="fas fa-list"></i>
                        Students List
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('add') ? 'active' : ''); ?>" href="<?php echo e(Route('add')); ?>"> <!-- Dynamic active class -->
...
<div class="logout-confirm-popup" id="logout-confirmation">
    ...
    <form method="POST" action="<?php echo e(route('logout')); ?>" id="logout-form" style="display: inline;">
...
</html><?php /**PATH C:\Users\BAKAYOKO 20\VirtualBox VMs\Desktop\learn_laravel\adninfees\resources\views/index.blade.php ENDPATH**/ ?>